...
React Cool Virtual is a [tiny](https://bundlephobia.com/result?p=react-cool-virtual) React hook that supplies you a better DX and modern way for virtualizing a large amount of data without struggle 😭.
